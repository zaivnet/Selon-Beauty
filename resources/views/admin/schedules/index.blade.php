    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-xl max-w-md w-full p-6 space-y-4">
        ...
        <form id="schedule-form" action="{{ route('admin.schedules.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="date" name="work_date" id="modal_work_date" required value="{{ date('Y-m-d') }}" class="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 text-xs focus:outline-none focus:ring-2 focus:ring-rose-500 bg-slate-50/50">
            </div>

    ...
    <div class="w-full max-w-md space-y-6 relative z-10">
        ...
        <div class="text-center space-y-3">
            ...
            <div>
                ...
                <p class="text-xs font-bold text-rose-500 dark:text-rose-400 uppercase tracking-widest mt-0.5">Password Baru</p>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800/90 backdrop-blur-md rounded-3xl border border-slate-200 dark:border-slate-700/80 shadow-2xl p-6 sm:p-8 space-y-6 transition-colors">
            ...
            <div class="border-b border-slate-200 dark:border-slate-700/80 pb-4">
                <h2 class="text-base font-extrabold text-slate-900 dark:text-white">Buat Password Baru</h2>
            ...
            <form action="{{ route('password.update') }}" method="POST" class="space-y-4" onsubmit="this.querySelector('button[type=submit]').disabled = true; this.querySelector('button[type=submit]').classList.add('opacity-50');">
                ...
                <div>
                    ...
                    <input type="email" 
                           ...
                           required 
                           readonly 
                           class="w-full px-4 py-3 rounded-2xl bg-slate-100 dark:bg-slate-900/50 border border-slate-300 dark:border-slate-700/80 text-xs text-slate-500 dark:text-slate-300 focus:outline-none cursor-not-allowed">
                    @error('email')
                ...
                <!-- Password Baru -->
                <div>
                    <label for="password" class="block text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider mb-1.5">Password Baru *</label>
                    <input type="password" 
                           name="password" 
                           id="password" 
                           required 
                ...
                <div>
                    <label for="password_confirmation" class="block text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider mb-1.5">Konfirmasi Password Baru *</label>
                    <input type="password" 

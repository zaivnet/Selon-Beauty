        ...
        <div>
            ...
            <nav class="p-3 space-y-1.5 text-xs font-semibold">
                ...
                <a href="{{ route('admin.schedules.index') }}" 
                   :title="collapsed ? 'Penjadwalan Karyawan' : ''"
                   :class="collapsed ? 'justify-center px-0' : 'px-3'"
                   class="flex items-center gap-3 py-2.5 rounded-xl transition-all relative group {{ request()->routeIs('admin.schedules.*') ? 'bg-gradient-to-r from-rose-600 to-pink-600 text-white font-extrabold shadow-md shadow-rose-900/30' : 'text-slate-400 hover:text-white hover:bg-slate-800/80' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                    <span x-show="!collapsed" class="truncate">Penjadwalan</span>
                </a>
